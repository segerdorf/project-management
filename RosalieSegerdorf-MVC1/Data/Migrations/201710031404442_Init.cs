namespace RosalieSegerdorf_MVC1.Data.Migrations
{
    ...
    public partial class Init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ProjectLeader_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Users", t => t.ProjectLeader_Id)
                .Index(t => t.ProjectLeader_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Projects", "ProjectLeader_Id", "dbo.Users");
            DropForeignKey("dbo.Competences", "User_Id", "dbo.Users");
